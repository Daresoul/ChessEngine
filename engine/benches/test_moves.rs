...
fn criterion_benchmark(c: &mut Criterion) {
    ...
    let game2 = Game::new_from_string("8/5k2/3p4/1p1Pp2p/pP2Pp1P/P4P1K/8/8".to_string(), true);
    let game3 = Game::new_from_string("r1bk3r/p2pBpNp/k4k2/1p1KP2P/6P1/3P4/P1P1K3/q5b1".to_string(), true);
    ...
    let game = Game::new_from_string("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR".to_string(), false);
    let game2 = Game::new_from_string("8/5k2/3p4/1p1Pp2p/pP2Pp1P/P4P1K/8/8".to_string(), false);
    let game3 = Game::new_from_string("r1bk3r/p2pBpNp/k4k2/1p1KP2P/6P1/3P4/P1P1K3/q5b1".to_string(), false);
